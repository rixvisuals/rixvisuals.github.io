              ...
              <div className="w-full lg:w-[370px] bg-neutral-950 border-t lg:border-t-0 lg:border-l border-neutral-900 p-6 flex flex-col justify-between overflow-y-auto h-auto lg:max-h-[85vh]">
                ...
                <div className="pt-4 border-t border-neutral-900 flex flex-col gap-2">
                  <button
                    ...
                    className="w-full font-mono text-[10px] tracking-widest text-center stroke-none bg-white text-black py-3 hover:bg-neutral-200 transition-colors font-medium flex items-center justify-center gap-2 uppercase rounded-sm"
                  >
                    <ShoppingBag size={13} />
                    ORDER DIGITAL SHOT (R50)
                  </button>
                  <span className="text-[9px] font-mono text-neutral-400 text-center tracking-wider block uppercase">
                    *DIGITAL HIGH-RES FILE DELIVERABLE ONLY (NO PHYSICAL PRINT)
                  </span>
                </div>
              </div>
            </motion.div>
